  ...
  if (scheme === "dark") {
    return (
      <Image
        style={style}
        {...props}
        source={isAndroid ? HEADER_IMAGES.androidDark[index] : HEADER_IMAGES.iosDark[index]}
      />
    )
  } else {
    return (
      <Image
        style={style}
        {...props}
        source={isAndroid ? HEADER_IMAGES.androidLight[index] : HEADER_IMAGES.iosLight[index]}
      />
    )
  }
}
